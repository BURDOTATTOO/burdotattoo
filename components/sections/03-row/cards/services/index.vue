...
import ButtonGlobal from '~/components/atoms/buttons/glow-on/index.vue'
</script>
    ...
    <div class="item">
      ...
      <div class="details">
        ...
        <div class="description">
          ...
          <ButtonGlobal text="Leer más" link="/marketing-en-redes-sociales" />
        </div>
    ...
    <div class="item">
      ...
      <div class="details">
        ...
        <div class="description">
          ...
          <ButtonGlobal text="Leer más" link="/" />
        </div>
      </div>
